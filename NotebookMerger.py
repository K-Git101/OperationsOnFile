...
print("=== Science Notes ===")
with open(r"C:\Users\PC\OneDrive - Wellington College India\Desktop\Python Classes\P-Lesson 15\science-notes.txt", "r") as f:
    for line in f:
        print(line.strip())
print()

print("=== Word Count ===")
with open(r"C:\Users\PC\OneDrive - Wellington College India\Desktop\Python Classes\P-Lesson 15\maths-notes.txt", "r") as f:
    for line in f:
        words = line.split()
